...
from saniaxrobot.__main__ import STATS, TOKEN, USER_INFO
from saniaxrobot.modules.sql import SESSION
import saniaxrobot.modules.sql.userinfo_sql as sql
from saniaxrobot.modules.disable import DisableAbleCommandHandler
from saniaxrobot.modules.sql.global_bans_sql import is_user_gbanned
from saniaxrobot.modules.sql.afk_sql import is_afk, set_afk
from saniaxrobot.modules.sql.users_sql import get_user_num_chats
from saniaxrobot.modules.helper_funcs.chat_status import sudo_plus
from saniaxrobot.modules.helper_funcs.extraction import extract_user
from saniaxrobot import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. Queen Of @Mazekubot. Bot Name Inspired From 'Zo'."
         disaster_level_present = True
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/DutabotID/26")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Xrynze Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By Mazekubot 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/DutabotID/25)
"""
